    ...
    if (target) {
      ...
      if (attroops > deftroops) {
        ...
        let awin = new Discord.MessageEmbed()
          ...
          .addFields(
            { name: '📜 Report of Jarl ' + message.author.username, value: '🏰 earned ' + iearn + '% influence and ' + ecoins + ' coins! <:BORS:837283775201148928>' },
        ...
        let aloss = new Discord.MessageEmbed()
          ...
          .addFields(
            ...
            { name: '📜 Report of Jarl ' + target.username, value: '🏰 earned ' + iearn + '% influence and ' + edcoins + ' coins! <:BORS:837283775201148928>' },
            { name: 'Troops Ready', value: deftroops.toLocaleString(), inline: true },
