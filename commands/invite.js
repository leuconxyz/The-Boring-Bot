module.exports = {
  ...
  execute(message, args, Discord) {
    let embed = new Discord.MessageEmbed()
      ...
      .addFields(
        { name: 'To join The Boring Club 🔓', value: 'Joining our community is very simple, all you have to do is click [here](https://discord.gg/vzdUDfz6zk), and you can also share it with your friends!' },
